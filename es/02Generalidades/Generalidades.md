...
| ANCHO DE VIA | LÍNEAS | LINEAS |
| :---: | :---: | :---: |
| NORMAL | 300 m | SECUNDARIAS |
| 1 m | 100 m | 60 m |
| 0.75 m | 80 m | 40 m |
...
| :--- | :--- | :--- | :--- |
| RADIO |  |  | CURVAS NO |
|  | CURVAS CON TRANSICIÓN PERALTADAS | (SIN TRANSICIÓN) |  |
| 200 m | $\mathbf{6 4 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{5 5 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{3 7 ~ k m} \boldsymbol{/} \mathbf{h}$ |
| 300m | 78km/h | $\mathbf{6 5 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{4 5 ~ k m} \boldsymbol{/} \mathbf{h}$ |
| 400m | $\mathbf{9 0 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{7 6 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{5 2 ~ k m} \boldsymbol{/} \mathbf{h}$ |
| 500m | $101 \mathrm{~km} / \mathrm{h}$ | $\mathbf{8 5 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{5 8 ~ k m} \boldsymbol{/} \mathbf{h}$ |
| 900m | $\mathbf{1 3 5 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{1 1 4 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{7 8 ~ k m} \boldsymbol{/} \mathbf{h}$ |
| 1000 m | $\mathbf{1 4 2 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{1 2 0 ~ k m} \boldsymbol{/} \mathbf{h}$ | $\mathbf{8 2 ~ k m} \boldsymbol{/} \mathbf{h}$ |
